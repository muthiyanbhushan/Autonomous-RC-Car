...
if("TRUE" STREQUAL "TRUE")
  set(rospy_tutorials_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/rospy_tutorials)
  set(rospy_tutorials_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(rospy_tutorials_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rospy_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ubuntu <ubuntu@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rospy_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/rospy_tutorials/${idir}'.  Ask the maintainer 'ubuntu <ubuntu@todo.todo>' to fix it.")
    endif()
...
set(rospy_tutorials_EXPORTED_TARGETS "")
